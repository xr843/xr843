...
- **[llm-seclint](https://github.com/xr843/llm-seclint)** &nbsp; ![GitHub stars](https://img.shields.io/github/stars/xr843/llm-seclint?style=flat-square) — Static security linter for LLM-powered applications. 8 detection rules (prompt injection, SSTI, XXE, RCE, SQLi). The [Bandit](https://github.com/PyCQA/bandit) for the AI era.
...
| [Dify](https://github.com/langgenius/dify) | ![](https://img.shields.io/github/stars/langgenius/dify?style=flat-square&label=) | [#33858](https://github.com/langgenius/dify/pull/33858) | fix: use constant-time comparison for API key validation |
| [Dify](https://github.com/langgenius/dify) | | [#33840](https://github.com/langgenius/dify/pull/33840) | fix(security): prevent IDOR in DataSourceOauthBinding |
